...
// Per-route OG card for /shipped (D-01, D-02, D-03 + D-04 route.label substitution).
import { ImageResponse } from "next/og";
import { readFile } from "node:fs/promises";
import { join } from "node:path";

const ROUTE_LABEL = "shipped.app";
export const alt = "Bakytbek Tatibekov — Sr. Software Engineer (shipped.app)";
